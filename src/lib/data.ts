...
export const heroData: HeroData = {
  headline: "Descubra como uma simples dona de casa de 48 anos transformou R$14,90 em um salário de R$3.187,98",
  sub_headline: "APRENDA AGORA MESMO A FAZER OS MELHORES ALONGAMENTOS DE UNHAS",
  url_cta: "#pricing",
};
